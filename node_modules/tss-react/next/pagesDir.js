...
CacheProvider = react_1.CacheProvider) {
    ...
    function augmentDocumentWithEmotionCache(Document) {
        ...
        let createEmotionServer = undefined;
        Promise.resolve().then(() => __importStar(require("@emotion/server/create-instance"))).then(m => (createEmotionServer = m.default));
        Document.getInitialProps = (documentContext) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, assert_1.assert)(createEmotionServer !== undefined, "Emotion server not yet loaded. Please submit an issue to the tss-react repo");
